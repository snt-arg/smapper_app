...
const rosbags: RosbagMetadata[] = [
    {
        ...
        tags: ['driving', 'morning', 'city', 'morning', 'morning', 'morning', 'morning'],
        topics: [
            { id: 0, name: '/camera/front_right/image_raw', msg_type: 'sensor_msgs/Image' },
    ...
    },
    {
        ...
        topics: [
            { id: 2, name: '/camera/front_right/image_raw', msg_type: 'sensor_msgs/Image' },
    ...
    },
    {
        ...
        start_time: 1744189961,
        end_time: 1744191161,
        detail: 'This is a very long description of the rosbag which is supposed to show how this looks like in the rosbag card.',
        tags: ['testing', 'obstacles'],
        topics: [
            { id: 4, name: '/camera/front_right/image_raw', msg_type: 'sensor_msgs/Image' },
    ...
    },
    {
        ...
        tags: ['testing', 'obstacles'],
        topics: [
            { id: 9, name: '/camera/front_right/image_raw', msg_type: 'sensor_msgs/Image' },
    ...
    },
    {
        ...
        tags: ['testing', 'obstacles'],
        topics: [
            { id: 11, name: '/camera/front_right/image_raw', msg_type: 'sensor_msgs/Image' },
    ...
    },
    {
        ...
        tags: ['testing', 'obstacles'],
        topics: [
            { id: 13, name: '/camera/front_right/image_raw', msg_type: 'sensor_msgs/Image' },
